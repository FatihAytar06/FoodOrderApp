...
import com.example.foodorderapp.adapters.PlaceYourOrderAdapter;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private PlaceYourOrderAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardItemsRecyclerView = findViewById(R.id.cartItemsRecyclerView);
    ...
    private void OnPlaceOrderButtonClick(RestaurantModel restaurantModel){
        if (TextUtils.isEmpty(inputName.getText().toString())){
            ...
            inputState.setError("Please enter address");
            return;

        }
        else if(TextUtils.isEmpty(inputCardNumber.getText().toString())){
            inputState.setError("Please enter card number");
            return;
    ...
    private void initRecyclerView(RestaurantModel restaurantModel){
        cardItemsRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new PlaceYourOrderAdapter(restaurantModel.getMenus());
        cardItemsRecyclerView.setAdapter(adapter);
    }
